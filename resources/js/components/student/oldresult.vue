                                ...
                                <table class="w-100">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><b>ADMISSION NO:</b>
                                                ADM/PFC/{{ resultProfile[0].studentuseraccountid}}
                                            </td>
                                            <td rowspan=3>
                                ...
                                <table class="table table-striped table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody >
                                        <tr v-for="res in result" :key="res.id" >
                                                <td id="subject" class="text-light" v-if="res != ''">{{res[0].subjecttitle}}</td>
                            ...
                            <small>
                                <div class="row">
                                    <table class="table table-bordered">
                                        <thead class="thead" >
                                            <tr>
                                                <td  id="comment" class="text-light">Subject</td>
                                                <td   id="comment" class="text-light">Subject Teacher's comment</td>
                                            </tr>
                                        </thead>
                                        <tbody>
 ...
 <div class="content-body">
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        ...
                        <div class="row" v-if="!resultMode" id="result">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" v-model="getResult.classgroup" @change="getSubjectGroups">
                                                <option value="">--</option>
                                        ...
                                        <button class="btn btn-primary mt-2" @click.prevent=getStudentResult()>
                                                Generate Result
                                        </button>
                                ...
                                <table class="table table-bordered">
                                    <thead class="thead bg-dark">
                                        <tr>
                                            ...
                                            <td  class="text-light">Subject Teacher's comment</td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr v-for="comment in comments" :key="comment.id">
...
export default {
    ...
    methods: {
        ...
        getClassRoomGroup(){
            axios.get('api/classrmgroup/'+this.getResult.classgroup).then((result) => {
        ...
        getSubjectGroups(){
            axios.get('api/subjectGrpres/'+this.getResult.classgroup).then((result) => {
                ...
                getStudentsCount(){
                    axios.get('api/studentscount/'+this.resultProfile[0]['classid']).then((result) => {
        ...
        getStudentResult(){
            for (const key in this.subjects) {
                if (Object.hasOwnProperty.call(this.subjects, key)) {
                    ...
                    axios.get('api/result/'+this.user.id+'/'+this.getResult.academicPeriodid+'/'+element.id).then((result) => {
                        this.resultMode = true
                        student_result.push(result.data)
                        this.result = student_result
                        var student_profile = []

                        axios.get('api/result-profile/'+this.user.id+'/'+this.getResult.academicPeriodid+'/'+element.id).then((result) => {
            ...
            this.getPsychoMotor(this.user.id)
            this.getRemarks(this.user.id)
            this.getAffectiveDomain(this.user.id)
            this.getComments(this.user.id, this.getResult.academicPeriodid )
        },
...
computed: {
        scoreTotal() {
            const totalScores = []
            this.result.forEach(result => totalScores.push(parseFloat(result[0].score_obtained)  + parseFloat(result[1].score_obtained) + parseFloat(result[2].score_obtained) + parseFloat(result[3].score_obtained)));
