...
export default {
    ...
    methods: {
        ...
        getWards(){
            axios.get('api/ward/'+this.user.id).then((result) => {
        ...
        getStudentResult(){
            for (const key in this.subjects) {
                if (Object.hasOwnProperty.call(this.subjects, key)) {
                    ...
                    axios.get('api/result/'+this.getResult.ward+'/'+this.getResult.academicPeriodid+'/'+element.id).then((result) => {
                        this.resultMode = true
                        student_result.push(result.data)
                        this.result = student_result
                        var student_profile = []

                        axios.get('api/result-profile/'+this.getResult.ward+'/'+this.getResult.academicPeriodid+'/'+element.id).then((result) => {
            ...
            this.getPsychoMotor(this.getResult.ward)
            this.getRemarks(this.getResult.ward)
            this.getAffectiveDomain(this.getResult.ward)
            this.getComments(this.getResult.ward, this.getResult.academicPeriodid )
        },
